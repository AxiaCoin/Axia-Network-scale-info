...
//! [`overflow evaluating the requirement`] error [here](https://github.com/axia-tech/scale-info/blob/master/test_suite/tests/ui/pass_custom_bounds_fix_overflow.rs).
//!
...
//! https://github.com/axia-tech/ink/blob/master/abi/src/specs.rs
